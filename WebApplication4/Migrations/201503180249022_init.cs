    ...
    public partial class init : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                .ForeignKey("dbo.AspNetUsers", t => t.PostUser_Id)
                .Index(t => t.Parent_Id)
                .Index(t => t.PostUser_Id);
                ...
                c => new
                    {
                        ...
                        FirstName = c.String(),
                        LastName = c.String(),
                        Blogger = c.Boolean(nullable: false),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Posts", "PostUser_Id", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserLogins", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserClaims", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.Posts", "Parent_Id", "dbo.Posts");
